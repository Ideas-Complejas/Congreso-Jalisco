<!--Vista para confirmar la suscripción a la(s) inciativa(s)-->
<!DOCTYPE html>
				...
				<div class="col-md-10" style="background: white;padding: 2rem 3rem">
					...
					<div style="font-size: 1.0rem">
						...
						<div style="text-align: left; margin-top: 1em">
							Tu suscripción fue realizada a la(s) iniciativa(s):
							
								<?php if($nombre_iniciativas){
									echo "<ul>";
									foreach ($nombre_iniciativas as $key => $value) {
