					...
					<div class="row mb-4">
						<div class="col-md-2">
							<div class="fecha-list-iniciativa--container">
								<p class="fecha-number mb-1"></p>
								<p>Iniciativas</p>
							</div>
						</div>
						<div class="col-md-10">
							<h5 class="title-card--comision-lista">{{$value->titulo}}</h5>
							
							<a target="_blank" href="{{ url('iniciativas') }}/{{$value->titulo}}" class="button-detalle">ver detalle<i
								class="fas fa-chevron-right"></i>
							</a>
						</div>
					</div>
